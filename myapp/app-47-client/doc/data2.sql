...
insert into myapp_patient(patient_no, parent_no, name, breeds, age, address, phone, gender)
  values(21, 1, '하루', '고양이', 3, '서울시 동작구', 01010101010, 1);
insert into myapp_patient(patient_no, parent_no, name, breeds, age, address, phone, gender)
  values(22, 2, '하돌', '고양이', 3, '서울시 동작구', 01010101011, 1);
insert into myapp_patient(patient_no, parent_no, name, breeds, age, address, phone, gender)
  values(23, 3, '초코', '사자', 3, '서울시 강남구', 01010101012, 2);
insert into myapp_patient(patient_no, parent_no, name, breeds, age, address, phone, gender)
  values(24, 4, '여름', '팬더', 3, '서울시 중랑구', 01010101013, 1);
insert into myapp_patient(patient_no, parent_no, name, breeds, age, address, phone, gender)
  values(25, 5, '개똥이', '강아지', 3, '서울시 양천구', 01010101014, 2);
insert into myapp_patient(patient_no, parent_no, name, breeds, age, address, phone, gender)
  values(26, 6, '앵무', '조류', 3, '서울시 강서구', 01010101015, 1);
