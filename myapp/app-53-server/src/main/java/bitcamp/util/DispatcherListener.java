...
public class DispatcherListener implements ActionListener {
  ...
  public DispatcherListener() throws Exception {
    ...
    beanContainer.put("patientDao", patientDao);
    ...
    beanContainer.put("patient/add", new AnimalHospitalAddListener(patientDao, sqlSessionFactory));
    beanContainer.put("patient/list", new AnimalHospitalListListener(patientDao));
    beanContainer.put("patient/detail", new AnimalHospitalDetailListener(patientDao));
    beanContainer.put("patient/update", new AnimalHospitalUpdateListener(patientDao, sqlSessionFactory));
    beanContainer.put("patient/delete", new AnimalHospitalDeleteListener(patientDao, sqlSessionFactory));
