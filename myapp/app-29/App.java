...
import bitcamp.myapp_project.io.BufferedDataInputStream;
import bitcamp.myapp_project.io.BufferedDataOutputStream;
...
public class App {
  ...
  public App() {
    File file = new File("hospitals.data");
  ...
  private void loadMember() {
    try {
      BufferedDataInputStream in = new BufferedDataInputStream("hospital.data");
  ...
  private void saveMember() {
    try {
      BufferedDataOutputStream out = new BufferedDataOutputStream("hospital.data");
